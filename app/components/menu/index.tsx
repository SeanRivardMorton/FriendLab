  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button
          className="rounded-full w-[35px] h-[35px] inline-flex items-center justify-center text-primary bg-base-100 outline-none hover:bg-violet3 focus:shadow-[0_0_0_2px] focus:shadow-primary transition-shadow ease-in-out duration-200"
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          className="min-w-[220px] bg-base-100 rounded-md p-[5px] shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)] will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade"
          sideOffset={5}
        >
          <DropdownMenu.Group>
